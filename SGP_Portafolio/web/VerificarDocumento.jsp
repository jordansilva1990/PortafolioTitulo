...
<html lang="en">
    <head>
        ...
        <title>SGP Web - Verificar Documento</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <!-- Ejemplo Tabla -->
                                    <form action="<c:url value="/ControllerVerificarDocumento" />" method="post" style="margin-left: 50px">
                                        <center>
                                            <br>
                                            <div class="form-group">
                                                <input type="text" style="width: 200px;" name="codigo" placeholder="Ingrese su Código"></input>
                                            </div>
                                            <div class="form-group">
                                                <button style="width: 200px;" class="btn btn-success" type="submit" >Verificar Documento</button>
                                            </div>
