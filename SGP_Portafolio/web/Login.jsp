    ...
    <div class="login-dark" style="background-image:url(&quot;assets/img/vista hermosa.jpg&quot;);height:677px;color:rgb(192,192,192);">
        ...
        <form action="<c:url value="/ControllerLogin" />" method="post" style="border:2px solid;border-radius:25px;color:rgba(145,56,56,0.33);">
            ...
            <div class="form-group">
                <input class="form-control" type="text" name="rut" placeholder="Usuario" style="color:rgb(0,0,0);border:2px solid;border-radius:25px;background-color:gray;">
            </div>
            <div class="form-group">
                <input class="form-control" type="password" name="password" placeholder="Contraseña" style="border:2px solid;border-radius:25px;color:rgb(0,0,0);background-color:gray;">
            </div>
